...
func ([[ .typeName ]]) ConstValues() [][[ "github.com/go-courier/schema/pkg/enumeration.IntStringerEnum" | id ]] {
	return [][[ "github.com/go-courier/schema/pkg/enumeration.IntStringerEnum" | id ]]{
		[[ range .options ]][[ .Name ]], 
		[[ end ]] }
}
...
func (v [[ .typeName ]]) Value() ([[ "database/sql/driver.Value" | id ]], error) {
	offset := 0
	if o, ok := (interface{})(v).([[ "github.com/go-courier/schema/pkg/enumeration.DriverValueOffset" | id ]]); ok {
		offset = o.Offset()
	}
...
func (v *[[ .typeName ]]) Scan(src interface{}) error {
	...
	i, err := [[ "github.com/go-courier/schema/pkg/enumeration.ScanIntEnumStringer" | id ]](src, offset)
	if err != nil {
		return err
	}
	*v = [[ .typeName ]](i)
