...
func (i SecurityScheme) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(i.SecuritySchemeObject, i.SpecExtensions)
}

func (i *SecurityScheme) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &i.SecuritySchemeObject, &i.SpecExtensions)
}
...
func (i OAuthFlows) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(i.OAuthFlowsObject, i.SpecExtensions)
}

func (i *OAuthFlows) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &i.OAuthFlowsObject, &i.SpecExtensions)
}
...
func (i OAuthFlow) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(i.OAuthFlowObject, i.SpecExtensions)
}

func (i *OAuthFlow) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &i.OAuthFlowObject, &i.SpecExtensions)
}
