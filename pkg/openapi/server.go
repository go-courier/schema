...
func (i Server) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(i.ServerObject, i.SpecExtensions)
}

func (i *Server) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &i.ServerObject, &i.SpecExtensions)
}
...
func (i ServerVariable) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(i.ServerVariableObject, i.SpecExtensions)
}

func (i *ServerVariable) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &i.ServerVariableObject, &i.SpecExtensions)
}
