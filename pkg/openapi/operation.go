...
func (op Operation) MarshalJSON() ([]byte, error) {
	return jsonschema.FlattenMarshalJSON(op.OperationObject, op.SpecExtensions)
}

func (op *Operation) UnmarshalJSON(data []byte) error {
	return jsonschema.FlattenUnmarshalJSON(data, &op.OperationObject, &op.SpecExtensions)
}
