...
func (Not) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 1 {
		return nil, errors.New("`not` should have at least 1 arguments")
	}
	...
	return nil, errors.New("`not` should have bool argument")
}
...
func (Neq) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`neq` should have at least 2 arguments")
	}
	finalArgs, err := ResolveArgs(ctx, args...)
	if err != nil {
		return nil, err
	}
	v1 := normalize(finalArgs[0])
	v2 := normalize(finalArgs[1])
...
func (Lt) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`lt` should have at least 2 arguments")
	}
	finalArgs, err := ResolveArgs(ctx, args...)
	if err != nil {
		return nil, err
...
func (Lte) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`lte` should have at least 2 arguments")
	}
	finalArgs, err := ResolveArgs(ctx, args...)
	if err != nil {
		return nil, err
	...
	v1 := normalize(finalArgs[0])
	v2 := normalize(finalArgs[1])
	return LessThan(v1, v2) || Equal(v1, v2), nil
}
...
func (Eq) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`eq` should have at least 2 arguments")
	}
	finalArgs, err := ResolveArgs(ctx, args...)
	if err != nil {
		return nil, err
...
func (Gt) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`gt` should have at least 2 arguments")
	}
	finalArgs, err := ResolveArgs(ctx, args...)
	if err != nil {
		return nil, err
...
func (Gte) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	...
	v1 := normalize(finalArgs[0])
	v2 := normalize(finalArgs[1])
	return GreaterThan(v1, v2) || Equal(v1, v2), nil
}
...
func (Match) Exec(ctx context.Context, args ...interface{}) (interface{}, error) {
	if len(args) < 2 {
		return nil, errors.New("`match` should have at least 2 arguments")
	}
